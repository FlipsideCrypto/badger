...
const Home = () => {
    const announcement = {
        color: 'cyan',
        message: <>
            <p>Badger is building in the open and did not have a beta phase. If you have any struggles or feedback, please reach out to us on <a className="link-text" href="https://discord.gg/8qZ7Y4Z" target="_blank" rel="noreferrer">Discord</a>.</p>
        </>,
    }
