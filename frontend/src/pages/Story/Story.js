	...
	return (
		<>
			<SEO
				...
				description={story && story.attributes.description}
			/>

			{story && (
				<div className="story">
					<div
						className="hero slim tiny"
						style={{
					...
					>
						<div className="container">
							<div>
								<Link to="/stories/" className="back">
									<FontAwesomeIcon
										icon={['fal', 'arrow-left']}
									/>
								...
								<a
									href={story.attributes.partner_url}
									target="_blank"
									rel="noreferrer"
								>
									<img
										className="logo"
										src={story.attributes.logo}
									/>
								</a>
								...
								<div
									className="stats"
									style={{
										color: story.attributes.color_dark
									}}
								>
									{story.attributes.stat_1_title && (
										<div className="metric">
											<h3>
												{story.attributes.stat_1_value.toLocaleString()}
											</h3>
											<h4>
												{story.attributes.stat_1_title}
											</h4>
									...
									{story.attributes.stat_2_title && (
										<div className="metric">
											<h3>
												{story.attributes.stat_2_value.toLocaleString()}
											</h3>
											<h4>
												{story.attributes.stat_2_title}
											</h4>
									...
									{story.attributes.stat_3_title && (
										<div className="metric">
											<h3>
												{story.attributes.stat_3_value.toLocaleString()}
											</h3>
											<h4>
												{story.attributes.stat_3_title}
											</h4>
