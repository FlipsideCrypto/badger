...
..\contracts\BadgerOrganizationLogic.sol::162 => managersLength == _isManager.length,
..\contracts\BadgerOrganizationLogic.sol::163 => "BadgerScout::setManagers: _managers and _isManager must be the same length."
..\contracts\BadgerOrganizationLogic.sol::187 => uint256 managersLength = _managers.length;
...
..\contracts\BadgerOrganizationLogic.sol::214 => uint256 hooksLength = _hooks.length;
..\contracts\BadgerOrganizationLogic.sol::217 => hooksLength == _isHook.length,
..\contracts\BadgerOrganizationLogic.sol::218 => "BadgerScout::setHooks: _hooks and _isHook must be the same length."
..\contracts\hooks\BadgerHooked.sol::81 => uint256 hooksLength = _hooks.length();
..\contracts\hooks\BadgerHooked.sol::167 => uint256 slotHooksLength = slotHooks.length;
...
..\contracts\BadgerOrganizationLogic.sol::471 => return keccak256(abi.encode(_manager));
..\contracts\BadgerOrganizationLogic.sol::486 => return keccak256(abi.encode(_id, _manager));
..\contracts\hooks\BadgerHooked.sol::38 => bytes32 public constant BEFORE_SET_HOOK = keccak256("beforeSetHook");
..\contracts\hooks\BadgerHooked.sol::41 => bytes32 public constant BEFORE_MINT = keccak256("beforeMintingHook");
..\contracts\hooks\BadgerHooked.sol::44 => bytes32 public constant BEFORE_REVOKE = keccak256("beforeRevokingHook");
..\contracts\hooks\BadgerHooked.sol::47 => bytes32 public constant BEFORE_FORFEIT = keccak256("beforeForfeitHook");
..\contracts\hooks\BadgerHooked.sol::50 => bytes32 public constant BEFORE_TRANSFER = keccak256("beforeTransferHook");
..\contracts\managers\BadgerManaged.sol::26 => * @dev The key is a `keccak256` hash of the address of the Manager.
...
..\contracts\BadgerOrganizationLogic.sol::191 => "BadgerScout::setManagers: _managers and _isManager must be the same length."
..\contracts\BadgerOrganizationLogic.sol::218 => "BadgerScout::setHooks: _hooks and _isHook must be the same length."
..\contracts\hooks\BadgerHook.sol::7 => import {ERC165} from "@openzeppelin/contracts/utils/introspection/ERC165.sol";
..\contracts\hooks\BadgerHooked.sol::10 => import {IERC165} from "@openzeppelin/contracts/utils/introspection/IERC165.sol";
..\contracts\hooks\BadgerHooked.sol::14 => import {EnumerableSet} from "@openzeppelin/contracts/utils/structs/EnumerableSet.sol";
..\contracts\hooks\BadgerHooked.sol::113 => "BadgerHooks::_setHook: Hook does not implement IBadgerHook."
..\contracts\hooks\BadgerHooked.sol::146 => "BadgerOrganizationHooked::_configHook: Hook is not enabled."
...
..\contracts\managers\BadgerManaged.sol::10 => import {IBadgerConfigured} from "../interfaces/IBadgerConfigured.sol";
..\contracts\managers\BadgerManaged.sol::51 => "BadgerOrganizationHooked::_configManager: Manager is not enabled."
