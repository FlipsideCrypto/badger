...
async function main() {
    ...
    const contractAddress = "0x364a94CCa33611e4B939ab5583Ee31e3B0a78744"
    ...
    // await clonedContract.createBadgeType(
    //     3,
    //     'Badger Test',
    //     'This is a test description.',
    //     'QmbMcuSsvD1wfrxB1rHHCcAFcZePCc9YrQdW9hkQtXmqbc',
    //     {gasLimit: 150000}
    // )
    // console.log('Badge Type created')

    // await clonedContract.mintBadge(
    //     deployer.address,
    //     3,
    //     {gasLimit: 75000}
    // )

    res = await clonedContract.uri(3)
